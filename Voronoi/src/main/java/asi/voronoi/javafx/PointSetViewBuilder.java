 ...
 * @author asi
 */
public class PointSetViewBuilder implements Builder<Region> {

    private final PointSetModel viewModel;
    private final Consumer<Runnable> pointFetcher;

    public PointSetViewBuilder(PointSetModel viewModel, Consumer<Runnable> pointFetcher) {
