...
public class TestVoronoiTree {
    ...
    public void testBuildStructure_complete() {
        ...
        b.insertNode(new Point(1, 0));
        b.insertNode(new Point(0, 5));
        b.insertNode(new Point(2, 4));
        b.insertNode(new Point(2, 7));
        b.insertNode(new Point(7, 3));
        b.insertNode(new Point(5, 4));
        b.insertNode(new Point(6, 7));
        IntervalTree c = new VoronoiTree();
        c.buildTree(b);
    ...
    public void testEnd2End() throws Exception {
        // binary tree for pointset
        // (0,2), (2,0), (2,4), (3,2), (4,0), (4,4) and (6,2)
        String expected = "(3.0,2.0)\n"
                        + "(2.0,0.0) (4.0,4.0)\n"
                        + "[(0.0,2.0)] [(2.0,4.0)] [(4.0,0.0)] [(6.0,2.0)]\n";
        BinaryTree b = new BinaryTree(new Point(3, 2));
        b.insertNode(new Point(2, 0));
        b.insertNode(new Point(4, 4));
        b.insertNode(new Point(0, 2));
        b.insertNode(new Point(2, 4));
        b.insertNode(new Point(4, 0));
        b.insertNode(new Point(6, 2));
        assertEquals(expected, b.toString());
        IntervalTree i1 = new IntervalTree();
        IntervalTree i1v = new IntervalTree();
        i1.buildTree(b);
        i1v.buildTree("src/test/resources/VoronoiTree_E2E_verify.it");
        assertEquals(i1v.toString(), i1.toString());
        IntervalTree vt = new VoronoiTree();
        vt.buildTree(b);
        vt.buildStructure();
        String actual = vt.info.toString();
